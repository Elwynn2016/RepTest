...
define('MAJPROFIL', ' SET email=:email, ville=:ville, pays=:pays, civilite=:civilite, naissance=:naissance, nom=:nom, prenom=:prenom, description=:description, mailing=:mailing WHERE id=:id');
