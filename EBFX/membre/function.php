...
class Inscription {
	...
	public static function inscrire($civilite, $nom, $prenom, $ville, $identifiant, $email, $passeUn, $passeDe) {
				...
				if($verifIdentifiant -> rowCount() != 1) {
					if(filter_var($email, FILTER_VALIDATE_EMAIL)) {
						...
						if($verifMail -> rowCount() != 1) {
							...
							$resultat = 'L\'adresse email '.$email.' existe d&eacute;j&agrave;';
						}
					}
					else {
					...
					$resultat = 'L\'identifiant saisi existe d&eacute;j&agrave;';
				}
			}
			else {
				$resultat = 'Le champ &quot;Saisir un Mot de Passe&quot; et le champ &quot;Resaisir un Mot de Passe&quot; doivent &ecirc;tre identiques';
			}
		}
		else {
	...
	public static function profil($identifiant, $email, $pass) {
		...
		$resultat = Bdd::connectBdd()->prepare(INSERT.MEMBREZ.PROFIL.'; '.UPDATE.MEMBREZ.MAJPROFIL);
